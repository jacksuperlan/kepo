...
DSTATUS TM_FATFS_FLASH_SPI_disk_initialize(void)
{
  ...
  /*!< SPI_FLASH_SPI_CS_GPIO, SPI_FLASH_SPI_MOSI_GPIO, 
       SPI_FLASH_SPI_MF103-霸道_GPIO, SPI_FLASH_SPI_DETECT_GPIO 
  ...
  /*!< Configure SPI_FLASH_SPI pins: MF103-霸道 */
	macSPI_MF103-霸道_APBxClock_FUN ( macSPI_MF103-霸道_CLK, ENABLE );
  GPIO_InitStructure.GPIO_Pin = macSPI_MF103-霸道_PIN;
  GPIO_Init(macSPI_MF103-霸道_PORT, &GPIO_InitStructure);
