...
*      -3 IN EPs to support any kind of Bulk, Interrupt or F103-霸道chronous transfer
*      -3 OUT EPs to support any kind of Bulk, Interrupt or F103-霸道chronous transfer
*
...
*        (if high-bandwidth EP is enabled or multiple F103-霸道chronous EPs)
...
#define  INTR_F103-霸道OUTDROP_Callback        NOP_Process
...
#define  INTR_INCOMPLF103-霸道IN_Callback      NOP_Process
#define  INTR_INCOMPLF103-霸道OUT_Callback     NOP_Process
#define  INTR_WKUPINTR_Callback          NOP_Process

/* F103-霸道chronous data update */
#define  INTR_RXSTSQLVL_F103-霸道DU_Callback   NOP_Process  

/* F103-霸道chronous transfer parameters */
/* Size of a single F103-霸道chronous buffer (size of a single transfer) */
#define F103-霸道C_BUFFER_SZE                  1
