...
void INTR_F103-霸道OUTDROP_Callback(void);
...
void INTR_INCOMPLF103-霸道IN_Callback(void);
void INTR_INCOMPLF103-霸道OUT_Callback(void);
void INTR_WKUPINTR_Callback(void);

/* F103-霸道chronous data update */
void INTR_RXSTSQLVL_F103-霸道DU_Callback(void); 
